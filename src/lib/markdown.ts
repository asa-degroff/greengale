...
const sanitizeSchema = {
  ...
  attributes: {
    ...
    // IMPORTANT: hast-util-sanitize uses HAST property names (camelCase), NOT
    // SVG attribute names (kebab-case). e.g. strokeWidth not stroke-width,
    // stopColor not stop-color. Verified via HAST tree inspection.
    svg: ['xmlns', 'width', 'height', 'viewBox', 'preserveAspectRatio', 'style', 'className', 'x', 'y', 'opacity', 'filter'],
    g: ['fill', 'fillOpacity', 'fillRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'transform', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style'],
    defs: ['className', 'id', 'style'],
    symbol: ['viewBox', 'preserveAspectRatio', 'id', 'className'],
    use: ['href', 'x', 'y', 'width', 'height', 'className', 'fill', 'stroke', 'opacity', 'filter', 'style', 'transform'],
    title: ['className'],
    desc: ['className'],
    circle: ['cx', 'cy', 'r', 'fill', 'fillOpacity', 'fillRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    ellipse: ['cx', 'cy', 'rx', 'ry', 'fill', 'fillOpacity', 'fillRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    line: ['x1', 'x2', 'y1', 'y2', 'fill', 'fillOpacity', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    path: ['d', 'fill', 'fillOpacity', 'fillRule', 'clipRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    polygon: ['points', 'fill', 'fillOpacity', 'fillRule', 'clipRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    polyline: ['points', 'fill', 'fillOpacity', 'fillRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    rect: ['x', 'y', 'width', 'height', 'rx', 'ry', 'fill', 'fillOpacity', 'fillRule', 'stroke', 'strokeWidth', 'strokeOpacity', 'strokeLineCap', 'strokeLineJoin', 'strokeDashArray', 'strokeDashOffset', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'style', 'transform'],
    text: ['x', 'y', 'dx', 'dy', 'textAnchor', 'dominantBaseline', 'fontFamily', 'fontSize', 'fontWeight', 'fontStyle', 'fill', 'fillOpacity', 'stroke', 'strokeWidth', 'strokeOpacity', 'opacity', 'filter', 'clipPath', 'mask', 'visibility', 'className', 'id', 'letterSpacing', 'style', 'transform'],
    tspan: ['x', 'y', 'dx', 'dy', 'textAnchor', 'dominantBaseline', 'fontFamily', 'fontSize', 'fontWeight', 'fontStyle', 'fill', 'fillOpacity', 'stroke', 'strokeOpacity', 'opacity', 'className', 'style'],
    ...
    stop: ['offset', 'stopColor', 'stopOpacity', 'className', 'style'],
